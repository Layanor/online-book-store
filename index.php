					...
					<?php foreach ($books as $book) { ?>
						<div class="card m-1">
							...
							<div class="card-body">
								...
								<a href="./book.php?id=<?= $book['id'] ?>" class="btn btn-blue">Reviews</a>
			...
			<div class="category">
				...
				<div class="list-group">
					<?php if ($categories == 0) {
						...
						<a href="#" class="list-group-item list-group-item-action active list-group-item-blue">Category</a>
						<?php foreach ($categories as $category) { ?>

							<a href="category.php?id=<?= $category['id'] ?>" class="list-group-item-blue list-group-item list-group-item-action">
								<?= $category['name'] ?></a>
					<?php }
					} ?>
				</div>
