function validation(e) {
	...
	var input_text1 = document.querySelector("#exampleInputname1");
	var input_text2 = document.querySelector("#exampleInputname2");
	var input_text3 = document.querySelector("#exampleInputPassword1");
    

	if (input_text.value.length <= 0  || input_text1.value.length <= 1 || input_text2.value.length <= 1 || input_text3.value.length <= 1) {
		return false;
	}
	else {
        e.target.submit();
