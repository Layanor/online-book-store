					...
					<tbody>
						...
						?>
							<tr>
								...
								<td>
									<a href="edit-book.php?id=<?= $book['id'] ?>" class="btn btn-warning mt-3" style="width: 100%;">
										Update</a>

									<a href="php/delete-book.php?id=<?= $book['id'] ?>" style="width: 100%;" class="btn btn-danger mt-3">
										Delete</a>
								</td>
							</tr>
						<?php } ?>
